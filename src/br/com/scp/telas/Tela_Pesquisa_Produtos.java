...
public class Tela_Pesquisa_Produtos extends javax.swing.JInternalFrame {
    ...
    public void listar_produtos() {
        ...
        try {
            ...
            String sql = "SELECT Pr.id, discriminacao, valor_unitario, id_cliente, CLI.nome, cpf FROM produtos AS Pr INNER JOIN clientes AS CLI ON (CLI.id = Pr.id_cliente) ";
    ...
    private void pesquisar_produtos() {
        ...
        String sql = "SELECT id, discriminacao, valor_unitario, id_cliente FROM produtos WHERE discriminacao LIKE ?";
        ...
        try {
            ...
            pst.setString(1, txt_pro_pesquisar.getText() + "%"); 
            rs = pst.executeQuery(); 
    ...
    private void initComponents() {
        ...
        txt_pro_pesquisar = new javax.swing.JTextField();
        ...
        txt_pro_pesquisar.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txt_pro_pesquisarKeyReleased(evt);
            }
        });
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addComponent(txt_pro_pesquisar, javax.swing.GroupLayout.PREFERRED_SIZE, 296, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGap(40, 40, 40)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addGap(18, 18, 18)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(txt_pro_pesquisar, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txt_pro_pesquisarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_pro_pesquisarKeyReleased
        // O método chama a pesquisa de produtos no banco de dados
        
       pesquisar_produtos();
    }//GEN-LAST:event_txt_pro_pesquisarKeyReleased
    ...
    private javax.swing.JTextField txt_pro_pesquisar;
